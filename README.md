...
| Layer | Choice | Notes |
|-------|--------|-------|
| Backend | Python + Flask or FastAPI | Lightweight, no magic |
| Database (MVP) | SQLite | File-based, trivially Dockerized |
| Database (future) | PostgreSQL | Migration is its own portfolio milestone |
| Frontend | Vanilla HTML / CSS / JS | No frameworks-du-jour |
| Deployment | Docker | Because "it works on my machine" is not a deployment strategy |
...
*TASKED — because the whiteboard wasn't working anyway.*
